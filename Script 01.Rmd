...
#tiff('Figure 3.tiff',width = 20, height = 15,units = "cm", res=600)
...
#tiff('Figure 4.tiff',width = 16.9, height = 16.9,units = "cm", res=600)
plot_grid(plot_grid
          (S_morpho,
            H_morpho,
            J_morpho,
...
#tiff('Figure 2.tiff',width = 13, height = 12,units = "cm", res=600)
...
analisis_morpho <- capscale(datos.trans_morpho ~ WTD+GDD+Rad+
                       ...
                       pH+Prec+K+Mg+Mn+Na+P+S+Si+Al+Ca+Fe, Metadata,
                     dist="bray")
...
analisis_morpho_fs <- capscale(datos.trans_morpho ~ GDD+pH+Prec+Mg, Metadata,
                     dist="bray")
summary(analisis_morpho_fs)
```
...
analisis_coi_fs <- capscale(datos.trans_coi ~ GDD+Sphagnum+Acrocarp_mosses+pH+Mg, Metadata,
                     dist="bray")
summary(analisis_coi_fs)
```
...
analisis_18S_fs <- capscale(datos.trans_18s ~ GDD+Brown_mosses+
                       pH+Mg+S+Al, Metadata,
                     dist="bray")
summary(analisis_18S_fs)
```
